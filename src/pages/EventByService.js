...
//   } = props;
  ...
  const [dataToInsert, setDataToInsert] = useState(findData());
  useEffect(()=>{
    setDataToInsert(findData())
    ...
    <>
      <div className="top-img-container">
        <img
          ...
          src={require("../imgs/church-wide.jpg")}
          alt=""
        />

        <div className="top-img-title">{dataToInsert.key}</div>
      </div>
      <div className="main-container">
        ...
        <Row gutter={[60, 60]}>
          ...
          <Col sm={24} lg={12}>
            ...
            <Title style={{ textAlign: "left" }}>{dataToInsert.key}</Title>
            <hr align="left" className="thick-line"></hr>
            <p style={{ textAlign: "left" }}>{dataToInsert.writeup}</p>
            <Card
              bodyStyle={{
      ...
      {/* Need to find a better carousel, to change */}
      <Carousel autoplay>
            <div>
