...
function ChurchWide() {
  ...
  const data = [
    ...
    },
    {
      ...
      writeup:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in arcu lorem. Proin English Serviceim in fringilla iaculis. Etiam eu arcu ligula. Quisque English Serviceim et ligula suscipit tempor et scelerisque magna. Nunc leo ipsum, pellentesque porta metus id, efficitur fringilla sem.",
      time: "1-2pm",
      location: "Level 2, Joy Room ",
    },
    {
    ...
    <div>
      <div className="top-img-container">
        <img
          ...
          src={require("../imgs/service-timing.jpg")}
          alt=""
        />
        <div className="top-img-title">Services</div>
      </div>
              ...
              return (
                <Col sm={24} lg={12}>
                  ...
                  >
                    ...
                    <Meta
                      style={{ textAlign: "left" }}
                      avatar={<PushpinOutlined style={{ color: "#fa8c16" }} />}
                      title={i.location}
                    />
                  </Card>
                </Col>
